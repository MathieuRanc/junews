 ...
 */
final class Version20210617120946 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__cours AS SELECT id, lieu_id, nom, date_debut, date_fin, description FROM cours');
        $this->addSql('DROP TABLE cours');
        $this->addSql('CREATE TABLE cours (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, lieu_id INTEGER DEFAULT NULL, nom VARCHAR(255) NOT NULL COLLATE BINARY, date_debut DATETIME NOT NULL, date_fin DATETIME NOT NULL, description CLOB NOT NULL COLLATE BINARY, CONSTRAINT FK_FDCA8C9C6AB213CC FOREIGN KEY (lieu_id) REFERENCES lieu (id) NOT DEFERRABLE INITIALLY IMMEDIATE)');
        $this->addSql('INSERT INTO cours (id, lieu_id, nom, date_debut, date_fin, description) SELECT id, lieu_id, nom, date_debut, date_fin, description FROM __temp__cours');
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__evenement AS SELECT id, lieu_id, association_id, nom, description, date_debut, image FROM evenement');
        $this->addSql('DROP TABLE evenement');
        $this->addSql('CREATE TABLE evenement (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, lieu_id INTEGER DEFAULT NULL, association_id INTEGER NOT NULL, nom VARCHAR(255) NOT NULL COLLATE BINARY, description VARCHAR(255) NOT NULL COLLATE BINARY, date_debut DATETIME NOT NULL, image INTEGER DEFAULT NULL, date_fin DATETIME NOT NULL, CONSTRAINT FK_B26681E6AB213CC FOREIGN KEY (lieu_id) REFERENCES lieu (id) NOT DEFERRABLE INITIALLY IMMEDIATE, CONSTRAINT FK_B26681EEFB9C8A5 FOREIGN KEY (association_id) REFERENCES association (id) NOT DEFERRABLE INITIALLY IMMEDIATE)');
        $this->addSql('INSERT INTO evenement (id, lieu_id, association_id, nom, description, date_debut, image) SELECT id, lieu_id, association_id, nom, description, date_debut, image FROM __temp__evenement');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__cours AS SELECT id, lieu_id, nom, date_debut, date_fin, description FROM cours');
        $this->addSql('DROP TABLE cours');
        $this->addSql('CREATE TABLE cours (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, lieu_id INTEGER DEFAULT NULL, nom VARCHAR(255) NOT NULL, date_debut DATETIME NOT NULL, date_fin DATETIME NOT NULL, description CLOB NOT NULL)');
        $this->addSql('INSERT INTO cours (id, lieu_id, nom, date_debut, date_fin, description) SELECT id, lieu_id, nom, date_debut, date_fin, description FROM __temp__cours');
        $this->addSql('DROP TABLE __temp__cours');
        $this->addSql('CREATE INDEX IDX_FDCA8C9C6AB213CC ON cours (lieu_id)');
        $this->addSql('DROP INDEX UNIQ_717E22E3E7927C74');
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__evenement AS SELECT id, lieu_id, association_id, nom, description, date_debut, image FROM evenement');
        $this->addSql('DROP TABLE evenement');
        $this->addSql('CREATE TABLE evenement (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, lieu_id INTEGER DEFAULT NULL, association_id INTEGER NOT NULL, nom VARCHAR(255) NOT NULL, description VARCHAR(255) NOT NULL, date_debut DATETIME NOT NULL, image INTEGER DEFAULT NULL)');
        $this->addSql('INSERT INTO evenement (id, lieu_id, association_id, nom, description, date_debut, image) SELECT id, lieu_id, association_id, nom, description, date_debut, image FROM __temp__evenement');
        $this->addSql('DROP TABLE __temp__evenement');
        $this->addSql('CREATE INDEX IDX_B26681E6AB213CC ON evenement (lieu_id)');
        $this->addSql('CREATE INDEX IDX_B26681EEFB9C8A5 ON evenement (association_id)');
