 ...
 */
final class Version20210621123705 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__evenement AS SELECT id, lieu_id, association_id, nom, description, date_debut, image, date_fin FROM evenement');
        ...
        $this->addSql('INSERT INTO evenement (id, lieu_id, association_id, nom, description, date_debut, image, date_fin) SELECT id, lieu_id, association_id, nom, description, date_debut, image, date_fin FROM __temp__evenement');
